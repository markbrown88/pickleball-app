...
async function investigateTestTourney() {
  try {
    // Find Test Tourney
    const tournament = await prisma.tournament.findFirst({
      where: { name: { contains: 'test tourney', mode: 'insensitive' } },
      include: {
        brackets: true,
    ...
    console.error('Error investigating Test Tourney:', error);
  } finally {
    await prisma.$disconnect();
  }
}

investigateTestTourney();
