...
const merges: MergePair[] = [
  {
    name: 'Joan Hatch',
    keepId: 'cmihtciuc000pjm04r0u91naq', // Newer account with Clerk, email jhatch285@gmail.com
    deleteId: 'cmfpfjfmx000vrdb4hrljqf0q', // Older account with DUPR rating, region data
  },
  {
    name: 'Melissa Noronha',
    keepId: 'cmihyiicm0001l704ea0q7jn1', // Newer account with Clerk, email melnoronha4@gmail.com
    deleteId: 'cmfpbp8js002zrdn03hmexbzc', // Older account with location data
  },
];
