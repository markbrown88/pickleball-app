...
async function analyzeUsers() {
  try {
    const userId1 = 'cmh822cvr005xr0j4zxqi5got';
    const userId2 = 'cmh822d7s0067r0j4876omfru';
    ...
    if (user1 && user2) {
      ...
      if (user1.gender === user2.gender) matches.push('Gender');
      else diffs.push('Gender');

      if (user1.clubId === user2.clubId) matches.push('Club');
      else diffs.push('Club');
