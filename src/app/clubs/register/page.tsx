...
export const metadata: Metadata = {
  title: "Register Your Club - Klyng Cup Pickleball Championship",
  description: "Register your pickleball club to participate in the Klyng Cup Battle of the Clubs tournament series.",
};
      ...
      <section className="py-20 bg-surface-1">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {submitStatus === 'success' ? (
            <div className="text-center py-12">
              <div className="bg-surface-2 rounded-lg p-8 max-w-md mx-auto">
                ...
                <p className="text-muted mb-6">
                  Thank you for registering your club for the Klyng Cup. We'll review your application 
            ...
            <div className="card">
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-primary mb-4">Club Information</h2>
                <p className="text-muted">
                  Please provide the following information about your club. All fields marked with * are required.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-surface-2 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-sm text-muted">
                    ...
                    <p>
                      Registration is subject to approval. You will be notified within 1-2 business days 
