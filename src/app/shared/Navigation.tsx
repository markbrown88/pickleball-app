...
export type NavItem = {
  ...
  label: string;
  exact?: boolean;
  roles?: ('app-admin' | 'tournament-admin' | 'captain' | 'player')[];
  target?: '_blank';
};

export type UserRole = 'app-admin' | 'tournament-admin' | 'captain' | 'player';
...
export function getNavigationItems(): NavItem[] {
  return [
    { href: '/dashboard', label: 'Home', roles: ['app-admin', 'tournament-admin', 'captain', 'player'] },
    { href: '/profile', label: 'Profile', roles: ['app-admin', 'tournament-admin', 'captain', 'player'] },
    ...
    { href: '/results', label: 'Results', roles: ['app-admin', 'tournament-admin', 'captain', 'player'], target: '_blank' },
  ];
}
